        ...
        <div className='w-full bg-[#121212] p-5 text-[#f5f5f59d]'>
            <div className='flex justify-evenly mt-5'>
                ...
                <div className='w-[40%]'>
                    ...
                    <button className='mt-5 rounded-xl bg-[#F5F5F5] font-bold px-7 py-2 text-[#121212]' onClick={()=>navigate.push('/contact')}>Contact us</button>
                </div>
            </div>
            <div className='w-[80%] mx-auto text-lg mt-8 font-light text-center'>
